...
class InitialPromptRepository @Inject constructor(
     ...
     * 주석처리 된 프롬프트는 19금이거나 화질관련 또는 심한 중복이 있는 경우.
     */
...
//                PromptEntity.createPositive(prompt = "8k"),
                ...
                PromptEntity.createPositive(prompt = "intricate"),
...
//                PromptEntity.createPositive(prompt = "nipples"),
                PromptEntity.createPositive(prompt = "navel"),
                ...
                PromptEntity.createPositive(prompt = "bokeh"),
