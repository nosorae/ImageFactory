...
import com.yessorae.data.remote.stablediffusion.model.response.FetchQueuedImageResponseDto
...
interface TxtToImgApi {
    ...
    suspend fun fetchQueuedImage(@Body request: FetchQueuedImageRequestDto): Response<FetchQueuedImageResponseDto>
}
